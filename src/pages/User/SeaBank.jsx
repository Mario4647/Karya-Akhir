...
const HomePage = ({ onHistoryClick }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      {/* Header */}
      <div className="bg-blue-600 px-4 pt-8 pb-4">
        <div className="flex justify-between items-center mb-4">
          <div>
            <p className="text-blue-100 text-xs">Selamat Datang</p>
            <h2 className="text-white font-bold text-lg">Mario Septian Adi Mulyanto</h2>
          </div>
        ...
        <div className="bg-white rounded-xl p-5 shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-100">
            <div>
              <p className="text-gray-500 text-xs">Tabungan</p>
              <p className="font-semibold text-sm text-gray-800">Rp 661.000</p>
              <p className="text-green-600 text-xs">2,5% p.a. cair harian</p>
            </div>
            <div>
              <p className="text-gray-500 text-xs">Deposito</p>
              <p className="font-semibold text-sm text-gray-800">Rp 0</p>
              <p className="text-blue-600 text-xs">Hingga 6% p.a.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2 mt-4">
            ...
            <button className="flex flex-col items-center gap-1">
              <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center">
                <FaEllipsisH className="w-5 h-5 text-blue-600" />
              </div>
      ...
      <div className="px-4 mt-4">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-white text-sm font-semibold">Bayar Belanja & Tagihan Bisa Dengan SeaBank Virtual Account</p>
            </div>
      ...
      <div className="px-4 mt-6">
        ...
        <div className="space-y-3">
          {transactions.slice(0, 5).map((transaction) => (
            <div key={transaction.id} className="bg-white rounded-xl p-3 shadow-sm">
              <div className="flex items-center justify-between">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
        <div className="flex justify-around py-2 max-w-md mx-auto">
          ...
          <button className="flex flex-col items-center gap-0.5 text-gray-400">
            ...
            <span className="text-xs font-medium">Bayar/Transfer</span>
          </button>
          <button className="flex flex-col items-center gap-0.5 text-gray-400">
          ...
          <button className="flex flex-col items-center gap-0.5 text-gray-400">
            ...
            <span className="text-xs font-medium">Deposito</span>
          </button>
          <button className="flex flex-col items-center gap-0.5 text-gray-400">
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-blue-600 px-4 pt-8 pb-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-white text-lg font-bold flex-1">Riwayat Transaksi</h1>
        </div>
      </div>
