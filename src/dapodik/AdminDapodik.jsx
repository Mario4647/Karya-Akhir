...
const AdminDapodik = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      {/* Hanya gunakan AdminNavbar */}
      <AdminNavbar />
      
      {/* Konten utama dengan padding top untuk mengkompensasi navbar */}
      <div className="pt-16">
        <div className="container mx-auto px-4 py-8">
          ...
          {/* Pending Access Requests Card - dengan overflow scroll */}
                ...
                <div className="min-w-full">
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[200px]">Nama Siswa</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[120px]">Kelas</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[180px]">Tanggal Permintaan</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700 min-w-[150px]">Aksi</th>
                      </tr>
                    </thead>
