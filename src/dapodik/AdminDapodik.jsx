...
const AdminDapodik = () => {
  ...
  const [showTKAModal, setShowTKAModal] = useState(false); // Modal baru untuk TKA
  const [showUploadSertifikatModal, setShowUploadSertifikatModal] = useState(false); // Modal untuk upload sertifikat TKA
  ...
  // Fungsi untuk mendownload sertifikat TKA
  ...
  // Fungsi untuk mendapatkan status sertifikat
                      ...
                      <tr key={student.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-2">
                            {/* Tombol Upload/Download Sertifikat */}
                            <button
                              onClick={() => student.tka_sertifikat_file ? handleDownloadSertifikat(student) : openUploadSertifikatModal(student)}
                              disabled={!sertifikatStatus.disabled && !student.tka_sertifikat_file}
                              ...
                              } ${!sertifikatStatus.disabled && !student.tka_sertifikat_file ? 'opacity-50 cursor-not-allowed' : ''}`}
                            >
                              {student.tka_sertifikat_file ? '📥 Download Sertifikat' : '📤 Upload Sertifikat'}
                            </button>
                            
                            {/* Keterangan Status */}
                            <div className="text-xs text-center">
                              {student.tka_sertifikat_status === 'belum_upload' ? (
                                <span className="text-gray-500">
                                  <span className="inline-block mr-1">⚠️</span>
                                  Sertifikat Hasil TKA(SHTK) Belum di rilis oleh Dinas Pendidikan atau Kanwil Kemenag
                                </span>
                              ) : student.tka_sertifikat_file ? (
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-100">
                  <h4 className="text-sm font-medium text-yellow-800 mb-2">Informasi Sertifikat</h4>
                  <p className="text-xs text-yellow-700">
                    Sertifikat Hasil TKA (SHTK) biasanya dirilis oleh Dinas Pendidikan atau Kanwil Kemenag. 
                    Upload sertifikat dalam format PDF untuk memungkinkan siswa mendownloadnya.
                  </p>
                </div>
              </div>
            </div>
