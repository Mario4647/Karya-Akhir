...
const AdminDashboard = () => {
  ...
  // Handle Revoke Access from User
  ...
  // Filter users for access management
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-4 md:p-6">
      ...
      {partnerAccessList.length > 0 && (
        <div className="mb-6">
          <button
            onClick={() => alert(`Total partner dengan akses: ${partnerAccessList.length}`)}
            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-4 py-2 rounded-lg flex items-center shadow-lg transition-all duration-200"
          >
